...
# 例如，hist[0, 0] 表示类别 0 被正确预测的次数，hist[1, 2] 表示实际为类别 1 被错误预测为类别 2 的次数
...
def crf(n_jobs, is_coco=False):
    ...
    def process(i):
        ...
        if not args.eval_only:
            ...
            boxes_filt = get_grounding_output(gd_model, class_names, class_tree, image_path, cls_labels_dict, image_id,
                                              0.3)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--split_file", default="./voc12/train_aug.txt",
                        type=str)
    parser.add_argument("--cam_eval_thres", default=2, type=float)
    parser.add_argument("--gt_root", default="F:/Studyfiles/CLIP-ES-main/datasets/VOC2012/SegmentationClassAug",
                        type=str)
